  ...
  where
    ...
    basicGame =
        Simulation
            ...
            , simulationId = 1
            , simulationWallets = simulatorWallet registeredKnownCurrencies 100000000 <$> [wallet1, wallet2]
            , simulationActions =
                  [ lock wallet1 "Plutus" 50000000
                  , AddBlocks 1
    ...
    badGuess =
        Simulation
            ...
            , simulationId = 2
            , simulationWallets = simulatorWallet registeredKnownCurrencies 100000000 <$> [wallet1, wallet2, wallet3]
            , simulationActions =
                  [ lock wallet1 "Plutus" 50000000
                  , AddBlocks 1
